...
<title>Login Guru — SITUGAS</title>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .card {
    ...
    background: linear-gradient(160deg, #1a3fa8 0%, #7b93e8 45%, #FFFFFF 100%);
    border-radius: 10px; padding: 32px 28px 28px; width: 300px;
    display: flex; flex-direction: column; align-items: center; gap: 0;
  }
  .avatar {
    width: 60px; height: 60px; border-radius: 50%;
    background: rgba(26,63,168,0.2); border: 2px solid #1a3fa8;
  ...
  .field input {
    ...
    font-size: 13px; color: #1a2060; background: #fff; transition: box-shadow 0.2s;
  }
  .field input.error { box-shadow: 0 0 0 2px rgba(255,80,80,0.6); }
  .field input::placeholder { color: #aaa; }
  .field input:focus { box-shadow: 0 0 0 3px rgba(26,63,168,0.38); }
  ...
  .btn-masuk {
    ...
    background: #1a3fa8; color: #fff; font-size: 14px; font-weight: 600;
    cursor: pointer; letter-spacing: 0.5px; transition: background 0.2s, transform 0.1s;
  }
  .btn-masuk:hover { background: #122e80; }
  ...
  .link-siswa:hover { color: #fff; text-decoration: underline; }
</style>
</head>
<body>
...
<div class="card">
  ...
  <form method="POST" action="{{ route('login.guru.post') }}" style="width:100%">
    @csrf
