  ...
  <div class="main">
    ...
    <div class="content">
      <div class="form-card">
        ...
        <form method="POST" action="{{ route('guru.store-tugas') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="field">
            ...
            <label for="file_tugas" class="file-upload-box" style="cursor: pointer;">
              <div class="file-upload-icon">📤</div>
              <div class="file-upload-text">Pilih file atau drag & drop</div>
              <div class="file-upload-hint">PDF, Word, Excel, PowerPoint, TXT, ZIP (max 10MB)</div>
              <input 
                type="file" 
                id="file_tugas" 
                name="file_tugas" 
